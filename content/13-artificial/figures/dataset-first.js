...
//
// Serves §13.2. The claim is not that datasets and results co-occur — that
// would be a correlation and §13.4 has to fight about it. The claim is that
...
export function draw(root, values, { createDiagram }) {
  ...
  n.innerHTML = f === 'all'
    ...
    : `Three engineered domains. Two had corpora large enough to train against before the methods that would use ` +
      ...
      `which is §13.4's entire business.`;
  root.appendChild(n);
