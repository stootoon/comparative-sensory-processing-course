...
Olfaction faces the same pair of problems, and §3.1 argued they are <em>more</em> dissimilar than vision's: identity is categorisation in a non-metric chemical space, location is statistical inference over an intermittent time series. If the argument holds, olfaction should have separate machinery — and nobody can confidently point to it. That is §12's most actionable gap.
</x-callout>
