...
This section sets out the method and applies it to vision and audition, the two modalities with mature normative theories. §14.2 takes touch and taste, §14.3 the vestibular and proprioceptive systems, §14.4 the exotic senses, and §14.5 the two modules that are not modalities at all — development and evolution, and artificial sensing. §14.6 collects everything into a ranked agenda, §14.7 draws the conclusions, and §14.8 is the final exam.
...
<script type="application/json">
{
  ...
  "points": 5,
  "corner": "Axis",
  "prompt": "The datasheet as vision and audition leave it. Fill in what these two modalities alone establish — §12 pivots the completed version, with a column per modality, into the axes the course argues on.",
  "rows": [
