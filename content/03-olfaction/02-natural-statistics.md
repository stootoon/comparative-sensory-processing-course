...
The normative consequence is direct: **a modality whose input statistics are non-stationary cannot hard-wire an efficient code.** It must estimate its input statistics continuously and re-tune.
