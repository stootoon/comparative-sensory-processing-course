...
<script type="application/json">
{
  ...
  "contentRev": 1,
  "points": 1,
  "prompt": "The deblurring reframing is attractive, and §10.1 warns that attractive reframings are how unfalsifiable stories get in. Hold it to that standard. State what observation would refute the claim that olfactory localisation is inference under a transport model, and say honestly whether that observation is currently obtainable.",
