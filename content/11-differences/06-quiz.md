...
<script type="application/json">
{
  ...
  "options": [
    ...
    },
    {
      ...
      "correct": false,
      "feedback": "Correct under the assumption that dimension determines coordinates. It does not — knowing colour space is three-dimensional is a long way short of knowing it has opponent axes, which took a calculation on natural cone statistics [@buchsbaum1983]. An effective D of 8 gives you the size of the problem and none of its geometry, and the axes are what §12 wants."
    }
  ]
}
</script>
