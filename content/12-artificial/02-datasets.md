...
- **The theory reading.** Vision had a measured $p(x)$, which made efficient-coding derivations possible. Olfaction has no measured $p(x)$ over chemical composition, which is why the analogous derivation cannot be run. This is §13.7's Gap 1 exactly.
