...
<strong>1. Cancellation — from electroreception (§8.2).</strong><br>
...
<strong>2. Hyperacuity from slow elements — from electroreception (§8.2).</strong><br>
...
<strong>3. Acuity as deconvolution — from infrared (§8.4).</strong><br>
...
<strong>4. Sampling tracks uncertainty — from echolocation (§8.3).</strong><br>
...
<strong>5. Maps of derived variables — from echolocation (§8.3).</strong><br>
