...
<script type="application/json">
{
  ...
  "contentRev": 1,
  "points": 1,
  "prompt": "Taste's dimensions are nutritional categories — sugar, sodium, protein, acid, toxin — not chemical families. What does that suggest about the search for olfactory coordinates, which §12 poses as a statistics-of-the-stimulus problem?",
  "options": [
    {
